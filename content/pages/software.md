...
<div class="container support-buttons">
    ...
    <a role="button" href="https://www.buymeacoffee.com/joshbduncan" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/></svg>
        Buy Me A Coffee
    </a>
    <a role="button" href="https://www.paypal.com/donate/?hosted_button_id=F9WGMH9BSLKLA" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/></svg>
        Support on PayPal
    </a>
</div>
...
- [Match Objects](https://github.com/joshbduncan/illustrator-scripts/tree/main?tab=readme-ov-file#matchobjects)
- [Repeat After Me](https://github.com/joshbduncan/illustrator-scripts/tree/main?tab=readme-ov-file#repeatafterme)
- [Screen Printing Sep Marks](https://github.com/joshbduncan/illustrator-scripts/tree/main?tab=readme-ov-file#screensepmarks)
